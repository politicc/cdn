...
"hidden";d()};a.config.win.document.addEventListener?(a.config.win.addEventListener("focus",g,!0),a.config.win.addEventListener("blur",c,!0)):(a.config.win.document.attachEvent("onfocusin",g),a.config.win.document.attachEvent("onfocusout",c))}})(a.config.doc)},"1.2.1",{})},4026:function(h,k){YUI.add("squarespace-anim-raf",function(a){var g=a.config.win,e=g.requestAnimationFrame,d=g.cancelAnimationFrame||g.cancelRequestAnimationFrame,c=["moz","webkit"],b;for(b=0;b<c.length&&!e;b++)e=g[c[b]+"RequestAnimationFrame"],
d=g[c[b]+"CancelAnimationFrame"]||g[c[b]+"CancelRequestAnimationFrame"];if(d&&e){var f=null;a.Anim._startTimer=function(){f||(f=e(a.Anim._runAnimFrame))};a.Anim._stopTimer=function(){f&&(d(f),f=null)};a.Anim._runAnimFrame=function(){f&&(f=e(a.Anim._runAnimFrame),a.Anim._runFrame())}}},"1.0",{requires:["anim"]})},4027:function(h,k){YUI.add("squarespace-animations",function(a){a.namespace("Squarespace.Animations");var g=a.Squarespace.Animations.TransitionExpandable=a.Base.create("transitionExpandable",
...
left:0})}}).run());return new a.Do.Prevent("Slideable prevented default "+(e?"show":"hide")+" and used its own.")},_hardChangeVisibility:function(a){var d=this.get("host");d.setStyles({display:a?"block":"none"});d.fire(a?"shown":"hidden")}},{NS:"slideablePlugin",ATTRS:{duration:{value:0.2,validator:a.Lang.isNumber},easing:{value:a.Easing.easeOutStrong},opacity:{value:1}}})},"1.0",{requires:["anim","anim-easing","base","plugin","transition"]})},4028:function(h,k){YUI.add("squarespace-anims",function(a){function g(a){g.superclass.constructor.apply(this,
...
c.isNullOr(c.isNode);c.isNullOrNodeList=c.isNullOr(c.isNodeList)},"1.0",{requires:["squarespace-damask-context-globals"]})},4032:function(h,k){YUI.add("squarespace-beforeunload",function(a){var g=a.config.win.onbeforeunload;a.config.win.onbeforeunload=function(e){e=e||a.config.win.event;g&&g(e);var d=new a.DOMEventFacade(e);a.fire("gallery-dom0beforeunload",d);if(d=d.returnValue)return e.returnValue=d;a.config.win.onbeforeunload=g};a.Env.evt.plugins.beforeunload={on:function(e,d){var c=a.Array(arguments,
0,!0);c[0]="gallery-dom0beforeunload";return a.on.apply(a,c)}}},"1.0",{requires:[]})},404:function(h,k){h.exports=!0},405:function(h,k,a){k=a(1537);var g=a(130);a=Object.prototype;var e=a.hasOwnProperty,d=a.propertyIsEnumerable;a=k(function(){return arguments}())?k:function(a){return g(a)&&e.call(a,"callee")&&!d.call(a,"callee")};h.exports=a},4091:function(h,k,a){var g=a(2422);YUI.add("squarespace-map-block-data-utils",function(a){var d=[null,g.Original,g.Grayscale,g.Satellite,g.MinimalLight,g.MinimalDark,
...
a.__data__;return g(d)?c["string"==typeof d?"string":"hash"]:c.map}},4172:function(h,k,a){var g=a(2488),e=a(447),d=a(910),c=a(1756),b=a(886),f=a(969);YUI.add("squarespace-commerce-utils",function(a){a.namespace("Squarespace");a.Squarespace.Commerce={COMMERCE_DATE_TIME_FORMAT:"MMM D, YYYY  h:mma",isExpressCheckout:function(){return Static.POLITICC_CONTEXT.websiteSettings.storeSettings.expressCheckout},measurementStandard:function(){return a.Object.getValue(Static,["POLITICC_CONTEXT","websiteSettings",
...
"node","squarespace-escaping-utils"]})},4174:function(h,k,a){var g=a(1590),e=a(5187),d=a(6),c=a(2352),b=a(3028),f=a(67),l=a(780),n=a(5184),m=a(235),q=a(2929),p=a(5172),s=a(5178),r=a(3546),u=a(5169),w=a(217);window.Common=function(h){if(h.COMMON_ALREADY_RAN)console.warn("Common running twice... this is concerning.");else{h.COMMON_ALREADY_RAN=!0;h.Static=h.Static||{};"undefined"===typeof console&&(console={log:function(){},dir:function(){},warn:function(){},error:function(a){var b=Array.prototype.slice.call(arguments);
...
!0,a),!1;return a.Static.POLITICC_CONTEXT.websiteSettings&&a.Static.POLITICC_CONTEXT.authenticatedAccount&&!a.Static.POLITICC_CONTEXT.website.developerMode&&this._userHasPermissionsOnSite(a.Static.POLITICC_CONTEXT.permissions)&&a.top===a},getSession:function(a,b){try{if(b.sessionStorage&&b.sessionStorage[a])return b.sessionStorage[a]}catch(f){}return null},setSession:function(a,b,f){try{if(f.sessionStorage)return f.sessionStorage[a]=b,{success:!0,error:null}}catch(c){return{success:!1,
...
encodeURIComponent(b.location.pathname+b.location.search);b.location.href="/config/?frameUrl="+f}else b.Y=b.YUI(function(){var a={},f;for(f in b.YUI_CONFIG)a[f]=b.YUI_CONFIG[f];a.win=b;a.doc=b.document;a.scriptDoc=b.document;a.linkDoc=b.document;return a}()),b.Static.POLITICC_CONTEXT.collection&&(b.Static.POLITICC_CONTEXT.collectionId=b.Static.POLITICC_CONTEXT.collection.id),b.Static.POLITICC_CONTEXT.item&&(b.Static.POLITICC_CONTEXT.itemId=b.Static.POLITICC_CONTEXT.item.id),b.Y.use("squarespace-image-loader"),
...
linkDoc:a.document,injected:!1});a.top.YUI_config=top.Y.merge(YUI_CONFIG,{win:a,doc:a.document,scriptDoc:a.document,linkDoc:a.document,injected:!1});a.top.Common(a);["squarespace-management"].forEach(function(f){var c;a.top.Static.POLITICC_CONTEXT.frameRollups&&(c=a.top.Static.POLITICC_CONTEXT.frameRollups[f]);c&&(b[f]={css:[c.css],js:[c.js]})});for(var f in b)if(b[f].css)for(var c=0;c<b[f].css.length;c++)this._injectStylesheetFromTopFrame(b[f].css[c],a.document)},_injectStylesheetFromTopFrame:function(a,
...
afterBodyLoad:function(){var a=h.Y;if(!this.AFTER_BODY_LOADED){try{if(h.top.Y&&h.top.Y!==a&&"loading"===a.config.doc.readyState){a.once("domready",a.config.win.Squarespace.afterBodyLoad,a.config.win.Squarespace);return}}catch(b){}this.AFTER_BODY_LOADED=!0;a.use(function(b){h.Squarespace._fixRollupUnderscore(b);if(a.Lang.isString(b[0]))return b;var f=a.Object.keys(b);try{h.top&&h.top.CONFIG_PANEL&&["squarespace-management"].forEach(function(a){-1===f.indexOf(a)&&f.push(a)})}catch(c){}return f}(a.config.win.POLITICC_ROLLUPS),
h.Squarespace.globalInit)}},addLoadTrigger:function(a,b){var f=h.Y;if(f.one(a)){if(f.Squarespace.Utils.isInDamaskFrame()){var c=[];f.Array.each(b,function(a){f.Lang.isObject(h.YUI.Env.mods[a])&&c.push(a)});b=f.Array.filter(b,function(a){return!c.includes(a)});f.Array.each(c,function(b){f.use(b);var c=f.config.win.Static.POLITICC_CONTEXT.rollups[b];c?c.css&&(b=c.css.split(","),f.Array.each(b,function(a){this._injectStylesheetFromTopFrame(a,f.config.doc)},this)):console.warn("Unable to load module '"+
...
a.length&&e.push(a)})}f.Get.load([].concat(d,e),{win:f.config.win},function(a){f.use(b)})}}},globalInit:function(a){h.Static.POLITICC_CONTEXT.collection&&(h.Static.POLITICC_CONTEXT.collectionId=h.Static.POLITICC_CONTEXT.collection.id);h.Static.POLITICC_CONTEXT.item&&(h.Static.POLITICC_CONTEXT.itemId=h.Static.POLITICC_CONTEXT.item.id);a.Squarespace.EscManager&&a.Squarespace.EscManager.attach(a.one(a.config.win));a.Squarespace.Census.trackPageview();a.Squarespace.CensusHeartbeat.initializeHeartbeat();
n("en-US");a.config.win.Squarespace._humanizeAllDates(".timesince");a.config.win.Squarespace.initializeLayoutBlocks(a);a.config.win.Squarespace.initializeImageBlockDynamicElements(a);a.config.win.Squarespace.initializeGlobalLightbox(a);a.config.win.Squarespace.initializeVideo(a);var b=h.Static.POLITICC_CONTEXT.websiteSettings.disqusShortname;a.Lang.isValue(b)&&""!==b&&a.config.win.Squarespace.initializeDisqusCommentLinks(a);if(-1!==a.config.doc.location.href.indexOf("logout=true"))a.on("domready",
function(){new a.Squarespace.Widgets.Information({"strings.title":d("Logout Successful"),"strings.message":d("You have been successfully logged out.")})});if(h.Static.POLITICC_CONTEXT.websiteSettings.commentsEnabled){var b=h.Static.POLITICC_CONTEXT.demoCollections,f=h.Static.POLITICC_CONTEXT.collectionId,e=!1;a.Lang.isArray(b)&&a.Lang.isValue(f)&&-1!==a.Array.map(b,function(a){return a.collectionId}).indexOf(f)&&(e=!0);e||a.config.win.Squarespace.addLoadTrigger(".squarespace-comments",["squarespace-dialog",
"squarespace-comments"])}b=h.SQUARESPACE_LOGIN&&h.SQUARESPACE_LOGIN.isLoggedIn();f=c.shouldShowAnnouncementBar({settings:h.Static.POLITICC_CONTEXT.websiteSettings.announcementBarSettings,context:{pageType:h.Static.POLITICC_CONTEXT.pageType,collection:h.Static.POLITICC_CONTEXT.collection}});(b||f)&&a.config.win.Squarespace.addLoadTrigger("body",["squarespace-announcement-bar"]);var f=c.shouldShowSSBadge({websiteSettings:h.Static.POLITICC_CONTEXT.websiteSettings}),e=c.shouldShowMobileInformationBar({win:a.config.win,
isMobile:a.UA.mobile,settings:h.Static.POLITICC_CONTEXT.websiteSettings.mobileInfoBarSettings}),l=c.shouldShowLicensedAssetsBar({YNodeBody:a.one(a.config.doc.body)});(b||f||e||l)&&a.config.win.Squarespace.addLoadTrigger("body",["squarespace-website-overlays-manager"]);f=(f=h.Static.POLITICC_CONTEXT.websiteSettings.popupOverlaySettings)&&c.shouldShowPopupOverlay({settings:f,context:{pageType:h.Static.POLITICC_CONTEXT.pageType,collection:h.Static.POLITICC_CONTEXT.collection},isMobile:a.UA.mobile,
urlSearch:window.location.search});(b||f)&&a.config.win.Squarespace.addLoadTrigger("body",["squarespace-popup-overlay"]);a.config.win.Squarespace.addLoadTrigger(".sqs-audio-embed, .sqs-audio-playlist, .sqs-album-block",["squarespace-audio-player"]);a.Lang.isObject(h.Static.POLITICC_CONTEXT.websiteSettings.pinterestOverlayOptions)&&"disabled"!==h.Static.POLITICC_CONTEXT.websiteSettings.pinterestOverlayOptions.mode&&a.config.win.Squarespace.addLoadTrigger(q.TRIGGER_SELECTORS.join(","),["squarespace-pinterest"]);
...
["squarespace-share-buttons"]);h.Squarespace.globalMarkReady(a)},globalMarkReady:function(a){a.config.win.Squarespace.INITIALIZED||(k.forEach(function(a){try{a()}catch(b){console.error("Issue invoking page element initializer.",b)}}),a.config.win.Squarespace.INITIALIZED=!0,a.config.win.Squarespace.SQUARESPACE_INITIALIZED_ONCE=!0)},globalDestroy:function(a){a.config.win.Squarespace.INITIALIZED&&(a.config.win.Squarespace.INITIALIZED=!1,v.forEach(function(a){a()}))},initializeDisqusCommentLinks:function(a){var b=
a.all(".sqs-comment-link"),f,c=h.Static.POLITICC_CONTEXT.websiteSettings.disqusShortname,d=a.Lang.isString(c)&&""!==c;f=d?function(a){return h.Static.POLITICC_CONTEXT.website.baseUrl+a.getAttribute("href")+"#disqus_thread"}:function(b){return h.Static.POLITICC_CONTEXT.website.baseUrl+b.getAttribute("href")+a.substitute("#comment-{id}",{id:b.getAttribute("data-id")})};b.each(function(a){a.setHTML("Comments");a.setAttribute("href",f(a))},this);d&&(h.disqus_shortname=c,a.Get.script("//"+c+".disqus.com/count.js"))},
...
"toString",function(){return"function"==typeof this&&this[c]||b.call(this)})},4277:function(h,k){YUI.add("squarespace-dom-emitters-resize",function(a){a.Squarespace.ResizeEmitter=a.SQS.Gallery.ResizeEmitter},"1.0",{requires:["@sqs/yui-gallery/resize-emitter"]})},4278:function(h,k){YUI.add("squarespace-dom-emitters-scroll",function(a){a.namespace("Squarespace");a.Squarespace.ScrollEmitter=a.Base.create("ScrollEmitter",a.Base,[],{initializer:function(){var g=!1;this.scrollEventHandle=this.get("target").on("scroll",
function(){g||this.fire("scroll:start");g=!0;this.timer&&this.timer.cancel();this.timer=a.later(this.get("timeout"),this,function(){a.Env&&(this.fire("scroll:end"),g=!1)});this.fire("scroll")},this)},destructor:function(){this.timer&&this.timer.cancel();this.scrollEventHandle.detach()}},{ATTRS:{target:{valueFn:function(){return a.one(a.config.doc)}},timeout:{value:300}}})},"1.0",{requires:["base","node","event"]})},4279:function(h,k){YUI.add("squarespace-dombuilder",function(a){a.DB={unpackData:function(a,
...
(d._data=d.data());for(;c<e.length;++c)if(e[c]instanceof Array)for(b=0;b<e[c].length;++b)f=e[c][b],d.append(f);else f=e[c],d.append(f);return d}}},"1.0",{requires:["node"]})},428:function(h,k,a){var g=a(689),e=a(241);h.exports=function(a){return g(e(a))}},4281:function(h,k){YUI.add("squarespace-easing",function(a){a.namespace("Squarespace.Easing").easeInOutCubic=function(a,e,d,c){a/=c/2;if(1>a)return d/2*a*a*a+e;a-=2;return d/2*(a*a*a+2)+e}},"1.0",{requires:[]})},4289:function(h,k){YUI.add("squarespace-escaping-utils",
...
{requires:["squarespace-image-loader","squarespace-plugin-lightbox2","squarespace-video-loader","squarespace-widgets-lightbox2","@sqs/yui-gallery/manager"]})},4311:function(h,k){YUI.add("squarespace-gallery-ng",function(a){a.namespace("Squarespace");a.Squarespace.Gallery2=a.SQS.Gallery.Gallery2;a.Squarespace.GalleryDesigns2=a.SQS.Gallery.Designs},"1.0",{requires:["@sqs/yui-gallery"]})},4312:function(h,k,a){var g=a(6),e=a(235);YUI.add("squarespace-gallery",function(a){a.namespace("Squarespace");var c=
...
"generic";this._gismoEvents[e]=this._gismoEvents[e]||[];this._gismoEvents[e].push(a)},_getEvents:function(a){return this._gismoEvents[a||"generic"]},_flushEvents:function(g){var e=this._gismoEvents[g||"generic"];e&&(a.Array.invoke(e,"detach"),this._gismoEvents[g]=null)},_timer:function(a,e){e=e||"generic";this._timers[e]=this._timers[e]||[];this._timers[e].push(a)}}},"1.0",{requires:["array-invoke","squarespace-anims"]})},4321:function(h,k){YUI.add("squarespace-image-loader",function(a){a.namespace("Squarespace").Loader=
...
e))}}},"1.0",{requires:[]})},4330:function(h,k){YUI.add("squarespace-legacy-singleton",function(a){a.namespace("Squarespace.Legacy");a.Squarespace.Legacy.Singleton={create:function(a){var e=function(){};e.prototype=a;a=new e;a.ready&&a.ready();return a}}},"1.0",{requires:[]})},4337:function(h,k,a){var g=a(33);YUI.add("squarespace-logger",function(a){var d=[],c=null,b=a.Base.create("Logger",a.Base,[],{initializer:function(){a.one(a.config.win).on("beforeunload",this.flush,this);this._syncDebugActiveElement();
...
b){if(!e(a))return"symbol"==typeof a?a:("string"==typeof a?"S":"P")+a;if(!d(a,g)){if(!f(a))return"F";if(!b)return"E";n(a)}return a[g].i},getWeak:function(a,b){if(!d(a,g)){if(!f(a))return!0;if(!b)return!1;n(a)}return a[g].w},onFreeze:function(a){l&&(m.NEED&&f(a)&&!d(a,g))&&n(a);return a}}},4411:function(h,k){YUI.add("squarespace-plugin-lightbox2",function(a){a.namespace("Squarespace.Plugin");a.Squarespace.Lightbox2Plug=a.Squarespace.Plugin.Lightbox2=a.Base.create("Lightbox2Plug",a.Plugin.Base,[a.Squarespace.GismoBase],
...
"squarespace-widgets-lightbox2"]})},4414:function(h,k){YUI.add("squarespace-plugin-node-destroy-notifier",function(a){a.Squarespace.NodeDestroyNotifier=a.SQS.Gallery.NodeDestroyNotifier},"1.0",{requires:["@sqs/yui-gallery/node-destroy-notifier"]})},4416:function(h,k){YUI.add("squarespace-plugin-scroll-lock",function(a){a.namespace("Squarespace.Plugin").ScrollLock=a.Base.create("ScrollLock",a.Plugin.Base,[],{initializer:function(g){var e=this.get("host"),d=e.getDOMNode();this.listener=function(c){c.stopPropagation();
...
4422:function(h,k,a){var g=a(67);YUI.add("squarespace-rendering",function(a){a.Squarespace.Rendering={getWidthForHeight:function(a,c,b){return a/c*b},getHeightForWidth:function(a,c,b){return c/a*b},getDimensionsFromNode:function(d){if(d=d.getAttribute("data-image-dimensions")){if(a.Lang.isString(d))return d=d.split("x"),{width:parseInt(d[0],10),height:parseInt(d[1],10)}}else return{width:null,height:null}},getSquarespaceSizeForWidth:function(d){a.config.win.devicePixelRatio&&(d*=a.config.win.devicePixelRatio);
...
c+"</div>"),a.one(a.config.doc.body).append(this.errorEl),this.overlayEl=a.Node.create('<div class="dialog-screen-overlay sqs-system-error-overlay"></div>'),this.overlayEl.setStyles({zIndex:1E7}),a.one(a.config.doc.body).append(this.overlayEl),(new a.Anim({node:this.overlayEl,to:{opacity:1},duration:0.35,easing:a.Easing.easeOutStrong})).run())}})},"1.0",{requires:["squarespace-escaping-utils","squarespace-util"]})},4448:function(h,k){YUI.add("squarespace-touch-event-listener",function(a){a.Squarespace.TouchEventListener=
...
"1.0",{requires:"base dom-style-ie event-key event-mouseenter node plugin squarespace-animations squarespace-dom-emitters-resize squarespace-escmanager squarespace-plugin-scroll-lock squarespace-touch-event-listener squarespace-video-loader squarespace-widgets-gismo squarespace-widgets-lightbox2-overlay yui-throttle".split(" ")})},447:function(h,k){h.exports={PHYSICAL:1,DIGITAL:2,SERVICE:3,GIFT_CARD:4}},4474:function(h,k){YUI.add("squarespace-widgets-position-helper",function(a){function g(b,f,c,
