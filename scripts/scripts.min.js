...
json:!0,data:e,success:b,failure:b})})}return a.Promise.resolve()},trackOverlayEvent:function(b){if(this.shouldRecord()){var e=d.hit(this._noCookieAllowed());b.visitorCookie=e;a.Squarespace.Census.addIntraPageEventFields(b);a.Data.post({url:"/api/census/overlay",json:!0,data:b,success:f,failure:f})}},shouldRecord:function(){var b=Static.SQUARESPACE_CONTEXT;return!b.authenticatedAccount&&b.pageType!==g.NOT_FOUND&&b.pageType!==g.LOCK_SCREEN&&!0!==a.config.win.__WE_ARE_SQUARESPACE_DISABLING_CENSUS__},
_getPageviewData:function(){var b={queryString:a.config.win.location.search,referrer:a.config.win.document.referrer};try{window.localStorage.setItem("test",1),b.localStorageSupported=!0}catch(f){b.localStorageSupported=!1}return b},_addCoreSiteData:function(a){var b=Static.SQUARESPACE_CONTEXT;b.website&&(a.websiteId=b.website.id);b.templateId&&(a.templateId=b.templateId);return a},_isSearchPage:function(){return"/search"===a.config.win.location.pathname},_addClientData:function(b){b.userAgent=a.UA.userAgent;
...
a.__data__;return g(d)?c["string"==typeof d?"string":"hash"]:c.map}},4172:function(h,k,a){var g=a(2488),e=a(447),d=a(910),c=a(1756),b=a(886),f=a(969);YUI.add("squarespace-commerce-utils",function(a){a.namespace("Squarespace");a.Squarespace.Commerce={COMMERCE_DATE_TIME_FORMAT:"MMM D, YYYY  h:mma",isExpressCheckout:function(){return Static.SQUARESPACE_CONTEXT.websiteSettings.storeSettings.expressCheckout},measurementStandard:function(){return a.Object.getValue(Static,["SQUARESPACE_CONTEXT","websiteSettings",
...
afterBodyLoad:function(){var a=h.Y;if(!this.AFTER_BODY_LOADED){try{if(h.top.Y&&h.top.Y!==a&&"loading"===a.config.doc.readyState){a.once("domready",a.config.win.Squarespace.afterBodyLoad,a.config.win.Squarespace);return}}catch(b){}this.AFTER_BODY_LOADED=!0;a.use(function(b){h.Squarespace._fixRollupUnderscore(b);if(a.Lang.isString(b[0]))return b;var f=a.Object.keys(b);try{h.top&&h.top.CONFIG_PANEL&&["squarespace-management"].forEach(function(a){-1===f.indexOf(a)&&f.push(a)})}catch(c){}return f}(a.config.win.SQUARESPACE_ROLLUPS),
h.Squarespace.globalInit)}},addLoadTrigger:function(a,b){var f=h.Y;if(f.one(a)){if(f.Squarespace.Utils.isInDamaskFrame()){var c=[];f.Array.each(b,function(a){f.Lang.isObject(h.YUI.Env.mods[a])&&c.push(a)});b=f.Array.filter(b,function(a){return!c.includes(a)});f.Array.each(c,function(b){f.use(b);var c=f.config.win.Static.SQUARESPACE_CONTEXT.rollups[b];c?c.css&&(b=c.css.split(","),f.Array.each(b,function(a){this._injectStylesheetFromTopFrame(a,f.config.doc)},this)):console.warn("Unable to load module '"+
...
a.length&&e.push(a)})}f.Get.load([].concat(d,e),{win:f.config.win},function(a){f.use(b)})}}},globalInit:function(a){h.Static.SQUARESPACE_CONTEXT.collection&&(h.Static.SQUARESPACE_CONTEXT.collectionId=h.Static.SQUARESPACE_CONTEXT.collection.id);h.Static.SQUARESPACE_CONTEXT.item&&(h.Static.SQUARESPACE_CONTEXT.itemId=h.Static.SQUARESPACE_CONTEXT.item.id);a.Squarespace.EscManager&&a.Squarespace.EscManager.attach(a.one(a.config.win));a.Squarespace.Census.trackPageview();a.Squarespace.CensusHeartbeat.initializeHeartbeat();
n("en-US");a.config.win.Squarespace._humanizeAllDates(".timesince");a.config.win.Squarespace.initializeLayoutBlocks(a);a.config.win.Squarespace.initializeImageBlockDynamicElements(a);a.config.win.Squarespace.initializeGlobalLightbox(a);a.config.win.Squarespace.initializeVideo(a);var b=h.Static.SQUARESPACE_CONTEXT.websiteSettings.disqusShortname;a.Lang.isValue(b)&&""!==b&&a.config.win.Squarespace.initializeDisqusCommentLinks(a);if(-1!==a.config.doc.location.href.indexOf("logout=true"))a.on("domready",
function(){new a.Squarespace.Widgets.Information({"strings.title":d("Logout Successful"),"strings.message":d("You have been successfully logged out.")})});if(h.Static.SQUARESPACE_CONTEXT.websiteSettings.commentsEnabled){var b=h.Static.SQUARESPACE_CONTEXT.demoCollections,f=h.Static.SQUARESPACE_CONTEXT.collectionId,e=!1;a.Lang.isArray(b)&&a.Lang.isValue(f)&&-1!==a.Array.map(b,function(a){return a.collectionId}).indexOf(f)&&(e=!0);e||a.config.win.Squarespace.addLoadTrigger(".squarespace-comments",["squarespace-dialog",
"squarespace-comments"])}b=h.SQUARESPACE_LOGIN&&h.SQUARESPACE_LOGIN.isLoggedIn();f=c.shouldShowAnnouncementBar({settings:h.Static.SQUARESPACE_CONTEXT.websiteSettings.announcementBarSettings,context:{pageType:h.Static.SQUARESPACE_CONTEXT.pageType,collection:h.Static.SQUARESPACE_CONTEXT.collection}});(b||f)&&a.config.win.Squarespace.addLoadTrigger("body",["squarespace-announcement-bar"]);var f=c.shouldShowSSBadge({websiteSettings:h.Static.SQUARESPACE_CONTEXT.websiteSettings}),e=c.shouldShowMobileInformationBar({win:a.config.win,
isMobile:a.UA.mobile,settings:h.Static.SQUARESPACE_CONTEXT.websiteSettings.mobileInfoBarSettings}),l=c.shouldShowLicensedAssetsBar({YNodeBody:a.one(a.config.doc.body)});(b||f||e||l)&&a.config.win.Squarespace.addLoadTrigger("body",["squarespace-website-overlays-manager"]);f=(f=h.Static.SQUARESPACE_CONTEXT.websiteSettings.popupOverlaySettings)&&c.shouldShowPopupOverlay({settings:f,context:{pageType:h.Static.SQUARESPACE_CONTEXT.pageType,collection:h.Static.SQUARESPACE_CONTEXT.collection},isMobile:a.UA.mobile,
urlSearch:window.location.search});(b||f)&&a.config.win.Squarespace.addLoadTrigger("body",["squarespace-popup-overlay"]);a.config.win.Squarespace.addLoadTrigger(".sqs-audio-embed, .sqs-audio-playlist, .sqs-album-block",["squarespace-audio-player"]);a.Lang.isObject(h.Static.SQUARESPACE_CONTEXT.websiteSettings.pinterestOverlayOptions)&&"disabled"!==h.Static.SQUARESPACE_CONTEXT.websiteSettings.pinterestOverlayOptions.mode&&a.config.win.Squarespace.addLoadTrigger(q.TRIGGER_SELECTORS.join(","),["squarespace-pinterest"]);
...
a.all(".sqs-comment-link"),f,c=h.Static.SQUARESPACE_CONTEXT.websiteSettings.disqusShortname,d=a.Lang.isString(c)&&""!==c;f=d?function(a){return h.Static.SQUARESPACE_CONTEXT.website.baseUrl+a.getAttribute("href")+"#disqus_thread"}:function(b){return h.Static.SQUARESPACE_CONTEXT.website.baseUrl+b.getAttribute("href")+a.substitute("#comment-{id}",{id:b.getAttribute("data-id")})};b.each(function(a){a.setHTML("Comments");a.setAttribute("href",f(a))},this);d&&(h.disqus_shortname=c,a.Get.script("//"+c+".disqus.com/count.js"))},
...
c=a(181);h.exports=function(a){var f=1<arguments.length&&void 0!==arguments[1]?arguments[1]:{},h=window.Static.SQUARESPACE_CONTEXT;h.website&&(f.websiteId=h.website.id);h.templateId&&(f.templateId=h.templateId);h.templateInstallation&&h.templateInstallation.templateWebsite&&(f.variantId=h.templateInstallation.templateWebsite.id);var k=window.location,h=k.pathname,k=k.hash;f.pagePath=f.pagePath||h||"";k&&""!==k&&(f.pageHash=k.substring(1));return e.post("/api/events/RecordEvent",d.stringify({crumb:c.get("crumb"),
